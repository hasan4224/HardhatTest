...
#[derive(Debug)]
pub struct HardhatTestProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HardhatTestProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HardhatTest processing");
    
    let mut processor = HardhatTestProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HardhatTestProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HardhatTestProcessor::new(false);
